...
var createBEM_1 = bem$5.createBEM = createBEM;
...
function assignKey(to, from, key) {
  ...
  if (!hasOwnProperty.call(to, key) || !(0, _$4.isObject)(val)) {
    to[key] = val;
  } else {
...
zhCN.default = _default$5;
var _interopRequireDefault$9 = interopRequireDefault.exports;
locale.__esModule = true;
var default_1$1 = locale.default = void 0;
var _vue$2 = _interopRequireDefault$9(require$$1);
var _deepAssign = deepAssign$1;
var _zhCN = _interopRequireDefault$9(zhCN);
var proto = _vue$2.default.prototype;
var defineReactive = _vue$2.default.util.defineReactive;
...
default_1$1 = locale.default = _default$4;
var string = {};
...
var createComponent_1 = component.createComponent = createComponent$5;
var _$3 = utils;
var _string$1 = string;
var _slots = slots;
_interopRequireDefault$8(require$$1);
...
function createComponent$5(name) {
  return function(sfc) {
...
var _$2 = utils;
var _string = string;
var _locale = _interopRequireDefault$7(locale);
function createI18N$1(name) {
  var prefix = (0, _string.camelize)(name) + ".";
  return function(path) {
    var messages2 = _locale.default.messages();
    var message = (0, _$2.get)(messages2, prefix + path) || (0, _$2.get)(messages2, path);
...
var _vue$1 = _interopRequireDefault$6(require$$1);
var _create = create;
...
var isServer = _vue$1.default.prototype.$isServer;
...
var _extends2$2 = _interopRequireDefault$5(_extends$1.exports);
var _vue = _interopRequireDefault$5(require$$1);
...
function inherit(context2, inheritListeners) {
  ...
  if (inheritListeners) {
    result.on = result.on || {};
    (0, _extends2$2.default)(result.on, context2.data.on);
  }
  return result;
}
...
function mount(Component, data3) {
  var instance = new _vue.default({
    ...
    render: function render3(h) {
      return h(Component, (0, _extends2$2.default)({
        props: this.$props
      }, data3));
    }
  });
...
var _babelHelperVueJsxMergeProps$2 = _interopRequireDefault$4(helper);
var _extends2$1 = _interopRequireDefault$4(_extends$1.exports);
var _utils$3 = utils;
var _functional$3 = functional;
var _event$4 = event;
var _createNamespace$3 = (0, _utils$3.createNamespace)("overlay"), createComponent$4 = _createNamespace$3[0], bem$4 = _createNamespace$3[1];
function preventTouchMove(event2) {
  (0, _event$4.preventDefault)(event2, true);
}
function Overlay(h, props, slots3, ctx) {
  var style = (0, _extends2$1.default)({
    zIndex: props.zIndex
  }, props.customStyle);
  if ((0, _utils$3.isDef)(props.duration)) {
  ...
  return h("transition", {
  ...
  }, [h("div", (0, _babelHelperVueJsxMergeProps$2.default)([{
    "directives": [{
      name: "show",
      value: props.show
    }],
    ...
    "on": {
      "touchmove": props.lockScroll ? preventTouchMove : _utils$3.noop
    }
  }, (0, _functional$3.inherit)(ctx, true)]), [slots3.default == null ? void 0 : slots3.default()])]);
}
Overlay.props = {
  show: Boolean,
...
var _default$3 = createComponent$4(Overlay);
overlay.default = _default$3;
var node = {};
...
var _extends2 = _interopRequireDefault$3(_extends$1.exports);
var _overlay$1 = _interopRequireDefault$3(overlay);
...
function mountOverlay(vm) {
  return (0, _functional$2.mount)(_overlay$1.default, {
    on: {
...
function updateOverlay(vm) {
  ...
  if (item) {
    ...
    (0, _extends2.default)(overlay2, defaultConfig, config, {
      show: true
    });
  }
}
...
info.default = void 0;
var _babelHelperVueJsxMergeProps$1 = _interopRequireDefault$2(helper);
var _utils$2 = utils;
var _functional$1 = functional;
var _createNamespace$2 = (0, _utils$2.createNamespace)("info"), createComponent$3 = _createNamespace$2[0], bem$3 = _createNamespace$2[1];
function Info(h, props, slots3, ctx) {
  var dot = props.dot, info2 = props.info;
  var showInfo = (0, _utils$2.isDef)(info2) && info2 !== "";
  if (!dot && !showInfo) {
    return;
  }
  ...
  }, (0, _functional$1.inherit)(ctx, true)]), [dot ? "" : props.info]);
}
Info.props = {
  dot: Boolean,
  info: [Number, String]
};
var _default$2 = createComponent$3(Info);
info.default = _default$2;
var _interopRequireDefault$1 = interopRequireDefault.exports;
icon.__esModule = true;
icon.default = void 0;
var _babelHelperVueJsxMergeProps = _interopRequireDefault$1(helper);
var _utils$1 = utils;
var _functional = functional;
var _info = _interopRequireDefault$1(info);
var _createNamespace$1 = (0, _utils$1.createNamespace)("icon"), createComponent$2 = _createNamespace$1[0], bem$2 = _createNamespace$1[1];
...
function Icon(h, props, slots3, ctx) {
  ...
  return h(props.tag, (0, _babelHelperVueJsxMergeProps.default)([{
    ...
    "style": {
      color: props.color,
      fontSize: (0, _utils$1.addUnit)(props.size)
    }
  }, (0, _functional.inherit)(ctx, true)]), [slots3.default && slots3.default(), imageIcon && h("img", {
    "class": bem$2("image"),
    "attrs": {
      "src": name
    }
...
var _default$1 = createComponent$2(Icon);
icon.default = _default$1;
var _interopRequireDefault = interopRequireDefault.exports;
var default_1 = void 0;
var _utils = utils;
var _popup = popup;
var _icon = _interopRequireDefault(icon);
var _createNamespace = (0, _utils.createNamespace)("popup"), createComponent$1 = _createNamespace[0], bem$1 = _createNamespace[1];
var _default = createComponent$1({
  ...
  render: function render() {
    ...
    return h("transition", {
      ...
      "class": bem$1("close-icon", this.closeIconPosition),
      "on": {
...
export { index as Locale, MbPopup as default };
//# sourceMappingURL=index.full.es.js.map
